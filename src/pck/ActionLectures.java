...
public class ActionLectures implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch(case_action){
            ...
            JMenuItem add_new_student = new JMenuItem("Add a new student in this lecture");
            current_lecture.add(add_new_student);

            add_new_student.addActionListener(new ActionStudents(frame, lecture)); 
    ...
    public void print_students(){
        ...
        ArrayList<Student> students = lecture.get_lecture_student_list() ;
